...
useEffect(() => {
  ...
  return (
    <div className="min-h-screen bg-white">
      {/* Search Section */}
<section className="relative bg-gradient-to-br from-blue-50 via-blue-100 to-blue-200 py-8 overflow-hidden">
  {/* Enhanced Background Pattern */}
  <div className="absolute inset-0">
    <div className="absolute inset-0 bg-gradient-to-br from-white/30 via-blue-50/20 to-transparent"></div>
    <div className="absolute top-10 right-10 w-32 h-32 bg-gradient-to-r from-blue-300/20 to-blue-400/30 rounded-full blur-2xl animate-pulse"></div>
    <div className="absolute bottom-10 left-10 w-40 h-40 bg-gradient-to-r from-blue-200/25 to-blue-300/35 rounded-full blur-3xl animate-pulse" style={{animationDelay: '2s'}}></div>
    <div className="absolute top-1/2 left-1/3 w-24 h-24 bg-gradient-to-r from-white/40 to-blue-100/50 rounded-full blur-xl animate-pulse" style={{animationDelay: '1s'}}></div>
    
    {/* Geometric dots */}
    <div className="absolute top-20 left-20 w-2 h-2 bg-blue-400/40 rounded-full animate-bounce"></div>
    <div className="absolute top-40 left-40 w-1 h-1 bg-blue-500/50 rounded-full animate-bounce" style={{animationDelay: '0.5s'}}></div>
    <div className="absolute bottom-40 right-40 w-3 h-3 bg-blue-300/40 rounded-full animate-bounce" style={{animationDelay: '1s'}}></div>
  </div>

  <div className="relative w-full max-w-4xl mx-auto px-4">
    {/* Search Container with Enhanced Glass Effect */}
    <div className="bg-white/90 backdrop-blur-xl rounded-2xl shadow-2xl p-6 border border-white/30 hover:shadow-3xl transition-all duration-500">
      ...
      <div className="mb-6">
        <div className="relative group">
          ...
          />
          <div className="absolute inset-0 rounded-xl bg-gradient-to-r from-blue-500/5 to-blue-600/5 opacity-0 group-focus-within:opacity-100 transition-opacity duration-300 pointer-events-none"></div>
        </div>
      </div>
        ...
        <div className="flex justify-center gap-3 flex-wrap">
          {["Bibwewadi", "Baner", "Kothrud", "Kharadi", "Wakad"].map((location) => (
            <button
              ...
              className={`px-5 py-2.5 rounded-xl font-medium transition-all duration-300 text-sm shadow-lg hover:shadow-xl transform hover:scale-105 active:scale-95 relative overflow-hidden group ${
      ...
      <div className="text-center">
        <button
          ...
          className="inline-flex items-center gap-3 bg-gradient-to-r from-blue-600 via-blue-700 to-blue-800 text-white px-10 py-4 rounded-xl font-bold hover:from-blue-700 hover:via-blue-800 hover:to-blue-900 transition-all duration-300 text-base shadow-2xl hover:shadow-blue-400/25 transform hover:scale-105 active:scale-95 focus:outline-none focus:ring-4 focus:ring-blue-300/50 relative overflow-hidden group"
        >
  ...
  <div className="max-w-5xl mx-auto px-3 md:px-6 lg:px-8">
      ...
      <div className="flex items-center justify-center gap-6 mb-3">
        ...
        <div className="flex items-center space-x-3">
          <div className="relative">
            <Star className="w-5 h-5 md:w-6 md:h-6 text-blue-500 drop-shadow-sm" />
            <div className="absolute -top-1 -right-1 w-2 h-2 bg-blue-400 rounded-full animate-pulse"></div>
          </div>
          <h2 className="text-xl md:text-3xl font-bold text-gray-800 bg-gradient-to-r from-gray-800 to-blue-700 bg-clip-text">
        ...
        <Link to="/featured">
          <button className="group flex items-center gap-2 text-sm md:text-base text-blue-600 hover:text-blue-700 font-semibold px-4 py-2 rounded-full border border-blue-200 hover:border-blue-300 bg-white/80 backdrop-blur-sm hover:bg-blue-50/80 transition-all duration-300 shadow-sm hover:shadow-md transform hover:scale-105">
            View All
    ...
    <div className="relative max-w-2xl mx-auto">
      ...
      <button
        ...
        onClick={prevSlide}
        className={`absolute left-0 top-1/2 transform -translate-y-1/2 -translate-x-6 z-20 bg-white/90 backdrop-blur-sm rounded-full p-3 shadow-xl hover:shadow-2xl transition-all duration-300 border border-gray-200/50 hover:bg-white group ${
      ...
      <button
        onClick={nextSlide}
        className="absolute right-0 top-1/2 transform -translate-y-1/2 translate-x-6 z-20 bg-white/90 backdrop-blur-sm rounded-full p-3 shadow-xl hover:shadow-2xl transition-all duration-300 border border-gray-200/50 hover:bg-white group hover:scale-110"
      >
      ...
      <div className="overflow-hidden rounded-2xl shadow-lg">
        ...
        >
          {requirements.map((req, index) => (
            <div key={req.requirementId} className="w-full flex-shrink-0 p-1">
              <div className="bg-gradient-to-br from-white via-blue-50/20 to-white rounded-2xl shadow-xl p-6 md:p-8 border border-gray-100/50 hover:shadow-2xl transition-all duration-500 hover:scale-[1.02] relative overflow-hidden">
                ...
                <div className="relative z-10 space-y-6 text-center">
                  ...
                  <div className="space-y-3">
                    {/* <div className="inline-flex items-center gap-2 bg-blue-100/80 px-4 py-2 rounded-full">
                      <div className="w-2 h-2 bg-blue-500 rounded-full animate-pulse"></div>
                      <span className="text-xs md:text-sm font-semibold text-blue-700 uppercase tracking-wide">
                        Active Requirement
                      </span>
                    </div> */}
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="flex flex-wrap gap-2 justify-center">
                      {req.preferredLocations.map((location, idx) => (
                        <span
                          key={idx}
                          className="bg-gradient-to-r from-blue-500 to-blue-600 text-white px-4 py-2 rounded-full text-xs md:text-sm font-medium shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-105"
                        >
                          {location}
                        </span>
                      ))}
                  ...
                  <div className="bg-gray-50/80 rounded-xl p-4 space-y-2">
                    ...
                    <p className="text-gray-600 text-sm leading-relaxed">{req.additionalRequirements}</p>
                  </div>
                  ...
                  <div className="flex gap-3 justify-center pt-2">
                    ...
                    >
                      <Phone size={18} className={user ? "group-hover:animate-pulse" : ""} />
                      Call Now
                    </a>
                    ...
                    >
                      <MessageCircle size={18} className={user ? "group-hover:animate-bounce" : ""} />
                      WhatsApp
                    </a>
                  </div>
                </div>
